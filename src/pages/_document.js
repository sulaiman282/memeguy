...
export default function Document() {
  const siteTitle = "MEMEGUY - $PEACEGUY Official Website";
  const siteDescription = "Official website for MEMEGUY ($PEACEGUY) token. Find us on Dexscreener, Dextools, and Raydium.";
  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta name="keywords" content="MEMEGUY, PEACEGUY, crypto, token, Dexscreener, Dextools, Raydium, cryptocurrency" />
        <meta name="author" content="MEMEGUY Team" />
